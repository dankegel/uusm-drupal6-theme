			...
			<!-- <table width='620' height='490' cellspacing='0' cellpadding='0' border='0'><tr><td> -->
				...
				echo "<div id='slideshow'>";
					echo "<div id='quicklinks'>";
						...
						// echo "<img id='peace_site' src='/" . $directory . "/images/peace_site.gif' border=0>";
						echo "<span class='tagline'>We are a <a class='welcoming' href='/about-our-church/mission-and-vision/welcoming-congregation'><img align=absmiddle src='/" . $directory . "/images/welcoming.gif' alt='' border=0></a> and a designated <a class='peace_site' href='/about-our-church/mission-and-vision/peace-site'><img align=absmiddle src='/" . $directory . "/images/peace_site.gif' alt='' border=0></a></span>";
					echo '</div>';
					echo $slideshow;
				echo '</div>';
...
<div class="clear"></div>
<div id="footer"><?php echo $footer_message; ?></div>
<?php echo $closure; ?>
</body>
</html>
