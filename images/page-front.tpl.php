		...
		<div id="main">
			<!-- <table width='620' height='490' cellspacing='0' cellpadding='0' border='0'><tr><td> -->
				...
				echo "<div id='overlaytext'>";
					...
					echo "<div class='tagline'>We are a <a class='welcoming' href='/about-our-church/mission-and-vision/welcoming-congregation'><img align=absmiddle src='/" . $directory . "/images/welcoming.gif' alt='' border=0></a> and a designated <a class='peace_site' href='/about-our-church/mission-and-vision/peace-site'><img align=absmiddle src='/" . $directory . "/images/peace_site.gif' alt='' border=0></a></div>";
				echo '</div>';
